...
[likelihood, A, B, c] = test_gradient_reparam(O, m, n, eta, MaxIter);


plot (1:100 , likelihood (:) );
xlabel ('Iteration');
ylabel ('Log - Likelihood');
grid on ;


function [likelihood,A, B, c] = test_gradient_reparam (O ,m ,n , eta , MaxIter )
% model c h a r a c t er i s ti cs ...
