function [ Alfa , LogLik , u] = forward_algorithm_norm(A, B, O, c)
    % Forward algorithm with n or ma lizatio n
    % [ Alfa , LogLik ]= f o r w a r d _ a l g o r i t h m _ n o r m (A ,B ,O , c )
